...
void AckermannControllerPlugin::Load(physics::ModelPtr _parent, sdf::ElementPtr _sdf) {
	...
	ROS_WARN("starting ackermann plugin in ns: %s", robotNamespace_.c_str());
	...
	ROS_WARN_STREAM("AckermannPlugin tf_prefix:" << tf_prefix_ << " : " << nh_priv.getNamespace() << " : " << nh.getNamespace());
