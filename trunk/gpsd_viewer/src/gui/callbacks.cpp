...
extern "C" G_MODULE_EXPORT void on_menuitemMapProvider_group_changed(GtkRadioMenuItem * radiobutton, AppData * data) {
	...
	if (!check_menu_item->active) {
		...
		osm_gps_map_convert_screen_to_geographic(data->map, (gint) (data->map_container)->allocation.width / 2, (gint) (data->map_container)->allocation.height / 2, &current_coord);
		...
		case 10:
			...
			break;
		case 11:
			data->map_provider = OSM_GPS_MAP_SOURCE_YAHOO_STREET;
			data->map_zoom_max = 25;
			break;
		case 12:
			data->map_provider = OSM_GPS_MAP_SOURCE_YAHOO_SATELLITE;
			data->map_zoom_max = 22;
			break;
		case 13:
			data->map_provider = OSM_GPS_MAP_SOURCE_YAHOO_HYBRID;
			data->map_zoom_max = 22;
			break;
		case 14:
			data->map_provider = OSM_GPS_MAP_SOURCE_OSMC_TRAILS;
			data->map_zoom_max = 22;
			break;
		case 15:
			data->map_provider = OSM_GPS_MAP_SOURCE_OPENAERIALMAP;
			data->map_zoom_max = 22;
			break;
		case 16:
		...
		data->map = (OsmGpsMap *) g_object_new(OSM_TYPE_GPS_MAP, "map-source", data->map_provider, "tile-cache", data->cachedir, "proxy-uri", g_getenv("http_proxy"), "auto-center", FALSE, NULL);
