...
inline int Lower_Triangular_Solve(double *L, double B[], double x[], int n)
{
   int i, k;
...
inline void Unit_Upper_Triangular_Solve(double *U, double B[], double x[], int n)
{
   int i, k;
...
inline int Crout_LU_Decomposition(double *A, int n)
{
   int i, j, k, p;
...
inline int Crout_LU_Solve(double *LU, double B[], double x[], int n)
{
...
int main() {
    ...
    //gera uma matriz XxX com valores aleatorios de -50 a 50
