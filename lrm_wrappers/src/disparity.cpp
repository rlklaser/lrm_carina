                               ...
                               const CameraInfoConstPtr& r_info_msg)
{
  ...
  cv::Ptr<CvStereoSGBMState> params = block_matcher_.state;
...
PLUGINLIB_DECLARE_CLASS(lrm_wrappers, disparity,
		lrm_wrappers::DisparityNodelet, nodelet::Nodelet)
